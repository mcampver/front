...
import { ICreateFormBrands } from '@shared/interfaces/create-form-brands.interface';
import { FormValidationErrorNameEnum } from '@shared/enums/form-validation-error-name.enum';
import {
  createDialogIdFn,
  createFindOneResourceFnBrand,
...
export class CreateComponent {
  createForm = new FormGroup<ICreateFormBrands>({
    name: new FormControl('', {
      ...
      asyncValidators: [
        AiValidators.uniqFieldAsyncValidator(
          'name',
          createFindOneResourceFnBrand(BrandService),
          createDialogIdFn()
        ),
      ],
    }),

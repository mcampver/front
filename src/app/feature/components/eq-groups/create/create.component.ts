...
import {
  createDialogIdFn,
  createFindOneResourceFnEqGroups,
} from '@shared/functions';
import { ICreateFormEqGroups } from '@shared/interfaces/create-form-eq-groups';
...
export class CreateComponent {
  createForm = new FormGroup<ICreateFormEqGroups>({
    name: new FormControl('', {
      ...
      asyncValidators: [
        AiValidators.uniqFieldAsyncValidator(
          'name',
          createFindOneResourceFnEqGroups(EqGroupsService),
          createDialogIdFn()
        ),
      ],
    }),
  ...
  constructor(
    private service: EqGroupsService,

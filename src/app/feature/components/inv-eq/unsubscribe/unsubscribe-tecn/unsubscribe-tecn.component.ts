...
@Component({
  selector: 'ai-inv-eq-dbaja-tecnica',
  templateUrl: './unsubscribe-tecn.component.html',
  styleUrls: ['./_unsubscribe-tecn-theme.scss'],
  standalone: true,
  providers: [
    InvEqService,
...
export class UnsubscribeTecnComponent {
  selectAprov?: string;

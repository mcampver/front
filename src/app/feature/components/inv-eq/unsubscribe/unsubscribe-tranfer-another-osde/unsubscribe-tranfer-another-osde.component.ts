...
@Component({
  selector: 'ai-inv-eq-dbaja-otro-osde',
  templateUrl: './unsubscribe-tranfer-another-osde.component.html',
  styleUrls: ['./unsubscribe-tranfer-another-osde.component.scss'],
  standalone: true,
  providers: [
    InvEqService,
...
export class UnsubscribeTranferAnotherOsdeComponent {
  selectAprov?: string;

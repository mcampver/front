...
@Component({
  selector: 'ai-inv-eq-dbaja-empresa-externa',
  templateUrl: './unsubscribe-tranfer-external-company.component.html',
  styleUrls: ['./unsubscribe-tranfer-external-company.component.scss'],
  standalone: true,
  providers: [
    InvEqService,
...
export class UnsubscribeTranferExternalCompanyComponent {
  selectAprov?: string;

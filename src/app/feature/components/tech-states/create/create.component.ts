...
import { ICreateFormTechStates } from '@shared/interfaces/create-form-tech-states';
...
export class CreateComponent {
  createForm = new FormGroup<ICreateFormTechStates>({
  ...
  constructor(
    private service: TechStatesService,
